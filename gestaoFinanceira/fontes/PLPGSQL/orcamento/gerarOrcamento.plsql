...
*
* $Id: gerarOrcamento.plsql 63433 2015-08-27 19:36:24Z franver $
*
      ...
      GROUP BY entidade.exercicio;
        ...
        LOOP
            ...
            IF ( recRegistroAux.exercicio IS NULL AND recRegistroAux.num_pao IS NULL AND recRegistroAux.cod_acao IS NULL ) THEN
                INSERT INTO orcamento.pao (exercicio, num_pao , cod_acao) VALUES ( varProximoExercicio , recRegistro.num_pao , recRegistro.cod_acao );
            END IF;
        END LOOP;
