...
class VPPAManterRegiao
{
     ...
     *
     */
    public function listarRegioes($_REQUEST)
    {
    ...
    public function incluir($_REQUEST)
    {
        ...
        if ($obErro->ocorreu()) {
            ...
            $pgDestino = 'FMManterRegioes.php?stAcao=' . $_REQUEST['stAcao'];
            SistemaLegado::alertaAviso($pgDestino, $_REQUEST['inCodRegiao'], 'incluir', 'aviso', Sessao::getId(), '../');
        }
    }
    ...
    public function alterar($_REQUEST)
    {
        ...
        if ($obErro->ocorreu()) {
            ...
            $pgDestino = 'LSManterRegioes.php?stAcao=' . $_REQUEST['stAcao'];
            SistemaLegado::alertaAviso($pgDestino, $_REQUEST['inCodRegiao'], 'alterar', 'aviso', Sessao::getId(), '../');
        }
    }
    ...
    public function excluir($_REQUEST)
    {
        ...
        if ($arRetorno['boOcorreu']) {
            ...
            SistemaLegado::alertaAviso('LSManterRegioes.php?stAcao=excluir', $_REQUEST['inCodRegiao'], 'excluir', 'aviso', Sessao::getId());
        }
    }
