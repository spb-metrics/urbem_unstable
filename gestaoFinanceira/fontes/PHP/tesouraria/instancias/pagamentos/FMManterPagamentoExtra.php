...
if ($rsUltimoMesEncerrado->getCampo('mes') >= $mesAtual AND $boUtilizarEncerramentoMes == 'true') {
    ...
    $stNomHistorico = $_REQUEST['stNomHistorico'];
    Sessao::write('inCodPlanoCredito', $_REQUEST['inCodPlanoCredito']);
    Sessao::write('stNomContaCredito', $_REQUEST['stNomContaCredito']);
