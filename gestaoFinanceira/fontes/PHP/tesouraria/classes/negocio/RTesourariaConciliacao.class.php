...
<?php
 /**
    ...
    * @subpackage Regra
    ...
    $Name$
    $Autor: $
    $Date: 2008-03-07 16:05:15 -0300 (Sex, 07 Mar 2008) $
...
/*
$Log$
Revision 1.17  2007/09/14 20:58:11  cako
Ticket#9496#

Revision 1.16  2007/05/23 14:58:13  cako
Bug #9252#

Revision 1.15  2007/05/15 15:55:24  cako
Bug #9252#

Revision 1.14  2007/01/02 20:29:59  cako
Bug #7827#

Revision 1.13  2006/12/20 12:47:36  cako
Bug #7827#
    ...
    if ( !$obErro->ocorreu() ) {
        ...
        if ( is_array($this->arMovimentacaoManual)) {
            foreach ($this->arMovimentacaoManual as $key => $arMovimentacao) {
                ...
                $obTTesourariaConciliacaoManual->setDado("cod_plano", $this->obRContabilidadePlanoBanco->getCodPlano()  );
                $obTTesourariaConciliacaoManual->setDado("exercicio", $this->obRContabilidadePlanoBanco->getExercicio() );
                $obTTesourariaConciliacaoManual->setDado("sequencia"    , $inSequencia                    );
                $obTTesourariaConciliacaoManual->setDado("mes"          , $this->inMes                    );
