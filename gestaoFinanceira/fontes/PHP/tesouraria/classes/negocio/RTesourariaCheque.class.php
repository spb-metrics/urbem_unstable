...
class RTesourariaCheque
{
    ...
    * Método que inclui os cheques na base
    ...
    public function emitirPorOP($boTransacao = '')
    {
        ...
        $this->obTransacao->fechaTransacao($boFlagTransacao, $boTransacao, $obErro, $this->obTTesourariaChequeEmissaoOrdemPagamento);
    ...
    public function emitirPorTransferencia($boTransacao = '')
    {
        ...
        if (!$obErro->ocorreu()) {
            ...
            $this->obTTesourariaChequeEmissaoTransferencia->setDado ('exercicio'         ,$this->roRTesourariaBoletim->stExercicio);
            $this->obTTesourariaChequeEmissaoTransferencia->setDado ('cod_entidade'      ,$this->obRContabilidadeLancamentoValor->obRContabilidadeLancamento->obRContabilidadeLote->obROrcamentoEntidade->inCodigoEntidade);
            $this->obTTesourariaChequeEmissaoTransferencia->setDado ('tipo'              ,$this->obRTesourariaAutenticacao->stTipo);
            $obErro = $this->obTTesourariaChequeEmissaoTransferencia->inclusao($boTransacao);
        }

        $this->obTransacao->fechaTransacao($boFlagTransacao, $boTransacao, $obErro, $this->obTTesourariaChequeEmissaoTransferencia);
    ...
    public function emitirPorReciboExtra($arParam, $boTransacao = '')
    {
        ...
        $this->obTransacao->fechaTransacao($boFlagTransacao, $boTransacao, $obErro, $this->obTTesourariaChequeEmissaoReciboExtra);
    ...
    public function listCheque(&$rsCheque, $arParam = array(),$boTransacao = '')
    {
        ...
        if ($arParam['stTipoBusca'] == 'naoEmitidos') {
            ...
            case 'transferencia':
                ...
                if ($this->roRTesourariaBoletim->stExercicio) {
                    $stFiltro .= " AND cheque_emissao_transferencia.exercicio = '" . $this->roRTesourariaBoletim->stExercicio . "' ";
                }
                if ($this->obRContabilidadeLancamentoValor->obRContabilidadeLancamento->obRContabilidadeLote->obROrcamentoEntidade->inCodigoEntidade) {
                    $stFiltro .= ' AND cheque_emissao_transferencia.cod_entidade = ' . $this->obRContabilidadeLancamentoValor->obRContabilidadeLancamento->obRContabilidadeLote->obROrcamentoEntidade->inCodigoEntidade . ' ';
                }
    ...
    public function listChequesTransferencia(&$rsCheque, $boTransacao = '')
    {
        ...
        if ($this->roRTesourariaBoletim->stExercicio) {
            $stFiltro .= " cheque_emissao_transferencia.exercicio = '" . $this->roRTesourariaBoletim->stExercicio . "' AND ";
        }
        if ($this->obRContabilidadeLancamentoValor->obRContabilidadeLancamento->obRContabilidadeLote->obROrcamentoEntidade->inCodigoEntidade) {
            $stFiltro .= ' cheque_emissao_transferencia.cod_entidade = ' . $this->obRContabilidadeLancamentoValor->obRContabilidadeLancamento->obRContabilidadeLote->obROrcamentoEntidade->inCodigoEntidade . ' AND';
        }
        if ($this->obRTesourariaAutenticacao->stTipo) {
            $stFiltro .= " cheque_emissao_transferencia.tipo = '" . $this->obRTesourariaAutenticacao->stTipo . "' AND ";
        }
