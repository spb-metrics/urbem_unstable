...
class TTesourariaChequeEmissaoTransferencia extends Persistente
{
    ...
    public function recuperaChequeTransferenciaSaldo(&$rsRecordSet,$stFiltro="",$stOrder="",$boTransacao="")
    {
        $stSql = "
        SELECT
            T.cod_lote,
     ...
     */
    public function listChequesEmissaoTransferencia(&$rsRecordSet,$stFiltro="",$stOrder="",$boTransacao="")
    {
        $stSql = "
     ...
     * @return object $rsRecordSet
     */
    public function listChequesEmissaoTransferenciaBaixa(&$rsRecordSet,$stFiltro="",$stOrder="",$boTransacao="")
    {
        $stSql = "
        SELECT
            T.cod_lote,
