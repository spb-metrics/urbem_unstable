...
class TTesourariaChequeEmissaoOrdemPagamento extends Persistente
{
     ...
     */
    public function recuperaChequesOPSaldo(&$rsRecordSet,$stFiltro="",$stOrder="",$boTransacao="")
    {
        $stSql = "
     ...
     * @return object $rsRecordSet
     */
    public function listChequesEmissaoOP(&$rsRecordSet,$stFiltro="",$stOrder="",$boTransacao="")
    {
        $stSql = "
    ...
    public function recuperaPorChaveNaoAnulada(&$rsRecordSet,$stFiltro="",$stOrder="",$boTransacao="")
    {
        $stSql = " SELECT
