...
class TTesourariaChequeEmissaoReciboExtra extends Persistente
{
     ...
     */
    public function recuperaChequeReciboExtraSaldo(&$rsRecordSet,$stFiltro="",$stOrder="",$boTransacao="")
    {
        $stSql = "
     ...
     * @return object $rsRecordSet
     */
    public function listChequesEmissaoReciboExtra(&$rsRecordSet,$stFiltro="",$stOrder="",$boTransacao="")
    {
        $stSql = "
