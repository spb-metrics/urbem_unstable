...
/*
$Log$
Revision 1.19  2007/09/27 19:32:39  hwalves
Ticket#10259#

Revision 1.18  2007/07/24 14:15:19  bruce
Bug#9737#

Revision 1.17  2007/06/29 19:12:34  bruce
Bug #9169#

Revision 1.16  2007/05/10 18:32:24  cako
Ajuste na consulta pelo nome do município

Revision 1.15  2007/04/23 17:00:48  bruce
Colocada a palavra complemento antes de iniciar o complemento do item na descrição

Revision 1.14  2007/04/20 21:16:40  hboaventura
Bug #9064#

Revision 1.13  2006/07/21 19:37:48  cako
Bug #6636#

Revision 1.12  2006/07/05 20:47:06  cleisson
...
/**
     ...
     * @param Object $valor
*/
function setRconfiguracao($valor) { $this->obRConfiguracao = $valor; }
/**
     * @access Public
     * @param Object $valor
*/
function setDotacao($valor) { $this->inDotacao = $valor; }

/**
     * @access Public
     * @param Object $valor
*/
function getRConfiguracao() { return $this->obRConfiguracao;  }
/**
     * @access Public
     * @param Object $valor
*/
function getDotacao() { return $this->inDotacao;  }

/**
    * Método Construtor
    * @access Private
*/
function REmpenhoRelatorioAutorizacao()
{
...
/**
    ...
    * @access Public
*/
function geraRecordSet(&$arRecordSet, $stOrder = "cod_pre_empenho, num_item", $tipoRelatorio = 'autorizacao' , $stFiltro)
{
...
//$obTEmpenhoPreEmpenho->debug();exit;
    ...
    if ( !$rsRecordSet->eof() ) {
        ...
        foreach ($arDescricao as $stDescricao) {
            ...
            $arLinha4[$inCount]['pao']     = $rsRecordSet->getCampo( 'num_pao' ) . " - " . $rsRecordSet->getCampo( 'nom_pao' );
