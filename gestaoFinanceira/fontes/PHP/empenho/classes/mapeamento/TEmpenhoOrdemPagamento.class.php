...
class TEmpenhoOrdemPagamento extends Persistente
{
    ...
    */
    ...
    public function montaRecuperaRelacionamento()
    {
        ...
        $stSql .= "       ,entidade                                                                                                                         \n";
        $stSql .= "       ,cod_recurso                                                                                                                      \n";
        $stSql .= "       ,masc_recurso_red                                                                                                                       \n";
        $stSql .= "       ,cod_detalhamento                                                                                                                      \n";
        $stSql .= "       ,cgm_beneficiario                                                                                                                 \n";
        $stSql .= "       ,implantado                                                                                                                       \n";
        $stSql .= "       ,beneficiario                                                                                                                     \n";
        $stSql .= "       ,sum(num_exercicio_empenho) as num_exercicio_empenho                                                                              \n";
        $stSql .= "       ,exercicio_empenho                                                                                                                \n";
        $stSql .= "       ,'' as dt_estorno                                                                                                                 \n";
        $stSql .= "       ,coalesce(sum(valor_pagamento),0.00) as valor_pagamento                                                                           \n";
        $stSql .= "       ,coalesce(sum(valor_anulada  ),0.00) as valor_anulada                                                                             \n";
        $stSql .= "       ,coalesce(sum(saldo_pagamento),0.00) as saldo_pagamento                                                                           \n";
        $stSql .= "       ,nota_empenho                                                                                                                     \n";
        $stSql .= "       ,vl_nota                                                                                                                          \n";
        $stSql .= "       ,vl_nota_anulacoes                                                                                                                \n";
        $stSql .= "       ,vl_nota_original                                                                                                                 \n";
        $stSql .= "       ,CASE WHEN (sum(coalesce(saldo_pagamento,0.00)) < coalesce(vl_nota,0.00))                                                         \n";
        $stSql .= "                  and (vl_nota > 0.00 ) then 'A Pagar'                                                                                \n";
        $stSql .= "             WHEN (sum(coalesce(saldo_pagamento,0.00)) = coalesce(vl_nota,0.00))                                                         \n";
        $stSql .= "                  and (vl_nota > 0.00 ) then 'Paga'                                                                                   \n";
        $stSql .= "             WHEN ( vl_nota = 0.00  ) then 'Anulada'                                                                              \n";
        $stSql .= "        end as situacao                                                                                                                  \n";
        $stSql .= "       ,CASE WHEN coalesce(sum(valor_anulada),0.00) > 0.00 then 'Sim'  \n";
        $stSql .= "        else 'Não'                                                                                                                       \n";
        $stSql .= "        end as pagamento_estornado                                                                                                       \n";
        $stSql .= " from (                                                                                                                                  \n";
        ...
        $stSql .= "            ,1 as num_exercicio_empenho                                                                                                  \n";
        ...
        $stSql .= "            ,pe.implantado                                                                                                               \n";
        $stSql .= "            ,cgm_pe.nom_cgm as beneficiario                                                                                              \n";
        $stSql .= "            ,coalesce(nota_liq_paga.vl_pago    , 0.00) as valor_pagamento                                                           \n";
        $stSql .= "            ,coalesce(nota_liq_paga.vl_anulado, 0.00 ) as valor_anulada                                                              \n";
        $stSql .= "            ,coalesce(nota_liq_paga.saldo_pagamento, 0.00) as saldo_pagamento                                                       \n";
        $stSql .= "            ,nota_liq_paga.cod_nota                                                                                                      \n";
        $stSql .= "            ,empenho.retorna_notas_empenhos(op.exercicio,op.cod_ordem, op.cod_entidade) as nota_empenho                                  \n";
        $stSql .= "            ,sum(coalesce(tot_op.total_op,0.00)) as vl_nota                                                                                   \n";
        $stSql .= "            ,sum(coalesce(tot_op.anulacoes_op,0.00)) as vl_nota_anulacoes                                                                     \n";
        $stSql .= "            ,sum(coalesce(tot_op.vl_original_op,0.00)) as vl_nota_original                                                                    \n";
        $stSql .= "                                                                                                                                         \n";
        $stSql .= "     from empenho.ordem_pagamento as op                                                                                                  \n";
        $stSql .= "          left join empenho.ordem_pagamento_anulada as opa on  (                                                                         \n";
        $stSql .= "                 op.cod_ordem     = opa.cod_ordem                                                                                        \n";
        $stSql .= "             and op.exercicio     = opa.exercicio                                                                                        \n";
        $stSql .= "             and op.cod_entidade = opa.cod_entidade                                                                                      \n";
        ...
        $stSql .= "                 op.cod_ordem    = pl.cod_ordem                                                                                          \n";
        ...
        $stSql .= "          )                                                                                                       \n";
        $stSql .= "          join ( select  coalesce(sum(pl.vl_pagamento),0.00) - coalesce(opla.vl_anulado,0.00) as total_op    \n";
        $stSql .= "                        ,coalesce(opla.vl_anulado,0.00) as anulacoes_op                                      \n";
        $stSql .= "                        ,coalesce(sum(pl.vl_pagamento),0.00) as vl_original_op                                      \n";
        $stSql .= "                        ,pl.cod_ordem                                                                  \n";
        ...
        $stSql .= "                           ) as opla \n";
        $stSql .= "                             on ( \n";
        $stSql .= "                                      opla.cod_ordem    = pl.cod_ordem \n";
        ...
        $stSql .= "                                ) \n";
        $stSql .= "                where pl.cod_ordem is not null                                                                   \n";
        if ( $this->getDado( 'exercicio_op') ) {
        ...
        $stSql .= "          ) as tot_op on (                                                                                                               \n";
        $stSql .= "                 tot_op.cod_ordem    = pl.cod_ordem                                                                                      \n";
        $stSql .= "             and tot_op.exercicio    = pl.exercicio                                                                                      \n";
        $stSql .= "             and tot_op.cod_entidade = pl.cod_entidade                                                                                   \n";
        $stSql .= "          )                                                                                                                              \n";
        $stSql .= "                                                                                                                                         \n";
        $stSql .= "          join empenho.nota_liquidacao as nl on (     pl.cod_nota              = nl.cod_nota                                             \n";
        ...
        $stSql .= "                                                                                                                                         \n";
        $stSql .= "          left join (                                                                                                                    \n";
        $stSql .= "                      select  nlp.cod_entidade                                                                                           \n";
        $stSql .= "                             ,nlp.cod_nota                                                                                               \n";
        $stSql .= "                             ,plnlp.cod_ordem                                                                                            \n";
        $stSql .= "                             ,plnlp.exercicio                                                                                            \n";
        $stSql .= "                             ,nlp.exercicio as exercicio_liquidacao                                                                      \n";
        $stSql .= "                             ,sum(coalesce(nlp.vl_pago ,0.00)) as vl_pago                                                            \n";
        $stSql .= "                             ,sum(coalesce(nlpa.vl_anulado ,0.00)) as vl_anulado                                                         \n";
        $stSql .= "                             ,( sum(nlp.vl_pago) - coalesce(nlpa.vl_anulado,0.00) ) as saldo_pagamento                      \n";
        $stSql .= "                                                                                                                                         \n";
        ...
        $stSql .= "                                            GROUP BY exercicio, cod_nota, cod_entidade, timestamp                             \n";
        $stSql .= "                            ) as nlpa on (     nlp.exercicio    = nlpa.exercicio                                              \n";
        $stSql .= "                                         and nlp.cod_nota     = nlpa.cod_nota             \n";
        $stSql .= "                                         and nlp.cod_entidade = nlpa.cod_entidade         \n";
        $stSql .= "                                         and nlp.timestamp    = nlpa.timestamp            \n";
        $stSql .= "                                                                                      )                                                  \n";
        $stSql .= "                      where     nlp.cod_entidade = plnlp.cod_entidade                                                                    \n";
        ...
        $stSql .= "                                                                                                                                         \n";
        $stSql .= "                      group by  nlp.cod_entidade                                                                                         \n";
        $stSql .= "                               ,nlp.cod_nota                                                                                             \n";
        $stSql .= "                               ,nlp.exercicio                                                                                            \n";
        ...
        $stSql .= "                               ,plnlp.exercicio                                                                                          \n";
        $stSql .= "                                                                                                                                         \n";
        $stSql .= "                    ) as nota_liq_paga on (     pl.cod_nota     = nota_liq_paga.cod_nota                                                 \n";
        $stSql .= "                                            and pl.cod_entidade = nota_liq_paga.cod_entidade                                             \n";
        $stSql .= "                                            and pl.exercicio    = nota_liq_paga.exercicio                                                \n";
        $stSql .= "                                            and pl.cod_ordem    = nota_liq_paga.cod_ordem                                                \n";
        $stSql .= "                                            and pl.exercicio_liquidacao = nota_liq_paga.exercicio_liquidacao                             \n";
        $stSql .= "                                         )                                                                                               \n";
        $stSql .= "         join empenho.empenho as em on (    nl.cod_empenho       = em.cod_empenho                                                        \n";
        ...
        $stSql .= "                                       )                                                                                                 \n";
        $stSql .= "            join empenho.pre_empenho as pe on (     em.exercicio       = pe.exercicio                                                    \n";
        $stSql .= "                                                and em.cod_pre_empenho = pe.cod_pre_empenho                                              \n";
        if ( $this->getDado( 'exercicio_empenho') ) {
            $stSql .= "                                            and em.exercicio = '".$this->getDado('exercicio_empenho')."'                             \n";
        }
        $stSql .= "                                           )                                                                                             \n";
        $stSql .= "         join sw_cgm as cgm_pe on ( pe.cgm_beneficiario = cgm_pe.numcgm )                                                                \n";
        $stSql .= "         left join empenho.pre_empenho_despesa as ped on (     pe.cod_pre_empenho = ped.cod_pre_empenho                                  \n";
        $stSql .= "                                                           and pe.exercicio       = ped.exercicio                                        \n";
        $stSql .= "                                                    )                                                                                    \n";
        $stSql .= "                                                                                                                                         \n";
        $stSql .= "         left join orcamento.despesa as de on (     ped.cod_despesa = de.cod_despesa                                                     \n";
        $stSql .= "                                                and ped.exercicio   = de.exercicio                                                       \n";
        $stSql .= "                                         )                                                                                               \n";
        $stSql .= "         left join orcamento.recurso('".$this->getDado('exercicio_empenho')."') as rec                                              												\n";
        $stSql .= "                   on (    de.cod_recurso = rec.cod_recurso                                                     							\n";
        $stSql .= "                       and de.exercicio   = rec.exercicio                                                       							\n";
        $stSql .= "                                         )                                                                                               \n";
        $stSql .= "         join orcamento.entidade as en on (     op.cod_entidade = en.cod_entidade                                                        \n";
        $stSql .= "                                            and op.exercicio    = en.exercicio                                                           \n";
        $stSql .= "                                          )                                                                                              \n";
        $stSql .= "         join sw_cgm as cgm on ( en.numcgm = cgm.numcgm )                                                                                \n";
        $stSql .= "group by op.cod_ordem                                                                                                                    \n";
        $stSql .= "        ,op.exercicio                                                                                                                    \n";
        $stSql .= "        ,op.cod_entidade                                                                                                                 \n";
        $stSql .= "        ,to_char( op.dt_emissao   , 'dd/mm/yyyy' )                                                                                       \n";
        $stSql .= "        ,to_char( op.dt_vencimento, 'dd/mm/yyyy' )                                                                                       \n";
        $stSql .= "        ,op.observacao                                                                                                                   \n";
        $stSql .= "        ,cgm.nom_cgm                                                                                                                     \n";
        $stSql .= "        ,num_exercicio_empenho                                                                                                           \n";
        $stSql .= "        ,em.exercicio                                                                                                                    \n";
        ...
        $stSql .= "        ,pe.cgm_beneficiario                                                                                                             \n";
        $stSql .= "        ,pe.implantado                                                                                                                   \n";
        $stSql .= "        ,cgm_pe.nom_cgm                                                                                                                  \n";
        $stSql .= "        ,empenho.retorna_notas_empenhos(op.exercicio,op.cod_ordem, op.cod_entidade)                                                      \n";
        $stSql .= "        ,pl.exercicio_liquidacao                                                                                                         \n";
        $stSql .= "        ,nota_liq_paga.cod_nota                                                                                                          \n";
        $stSql .= "        ,nota_liq_paga.vl_pago                                                                                                           \n";
        $stSql .= "        ,nota_liq_paga.vl_anulado                                                                                                        \n";
        $stSql .= "        ,nota_liq_paga.saldo_pagamento                                                                                                   \n";
        $stSql .= ") as tabela                                                                                                                              \n";
        $stSql .= " group by                                                                                                                                \n";
        $stSql .= "     cod_ordem                                                                                                                           \n";
        $stSql .= "    ,exercicio                                                                                                                           \n";
        ...
        $stSql .= "    ,vl_nota_anulacoes                                                                                                                   \n";
        $stSql .= "    ) as tbl                                                                                                                             \n";
        $stSql .= "where num_exercicio_empenho > 0                                                                                                          \n";
