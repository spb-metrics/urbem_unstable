...
/**
    ...
    * @subpackage Mapeamento
    ...
    $Id: TOrcamentoProjetoAtividade.class.php 59950 2014-09-23 15:09:51Z arthur $
...
/**
    ...
    * @access Private
*/
function TOrcamentoProjetoAtividade()
{
    parent::Persistente();
...
*/
function recuperaPorNumAcao(&$rsRecordSet, $stCondicao = "" , $stOrdem = "" , $boTransacao = "")
{
    $obErro      = new Erro;
...
function montaRecuperaPorNumAcao()
{
    $stSql = "
...
function recuperaSemMascara(&$rsRecordSet, $stCondicao = "" , $stOrdem = "" , $boTransacao = "")
{
    $obErro      = new Erro;
    $obConexao   = new Conexao;
    $rsRecordSet = new RecordSet;
...
function montaRecuperaSemMascara()
{
    $stSql  = "  SELECT                                         \n";
...
function recuperaSemMascaraPorTipo(&$rsRecordSet, $stCondicao = "" , $stOrdem = "" , $boTransacao = "")
{
    $obErro      = new Erro;
    $obConexao   = new Conexao;
    $rsRecordSet = new RecordSet;
...
function montaRecuperaSemMascaraPorTipo()
{
    $stSql  = "  SELECT                                   \n";
...
function recuperaProximoCodPorTipo(&$rsRecordSet, $stCondicao = "" , $stOrdem = "" , $boTransacao = "")
{
    $obErro      = new Erro;
    $obConexao   = new Conexao;
    $rsRecordSet = new RecordSet;
...
function montaRecuperaProximoCodPorTipo()
{
