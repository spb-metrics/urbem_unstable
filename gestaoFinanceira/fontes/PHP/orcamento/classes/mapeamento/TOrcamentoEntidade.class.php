...
function montaRecuperaRelacionamentoNomes()
{
    ...
    $stSql .= "     ENT.cod_profissao      AS cod_profissao,        \n";
    $stSql .= "     CGM.numcgm             AS numcgm,               \n";
    $stSql .= "     CGM.nom_cgm            AS entidade,             \n";
    $stSql .= "     RESP.numcgm            AS cod_responsavel,      \n";
    $stSql .= "     RESP.nom_cgm           AS responsavel,          \n";
    $stSql .= "     RESPTEC.numcgm         AS cod_resp_tecnico,     \n";
    $stSql .= "     RESPTEC.nom_cgm        AS resp_tecnico,         \n";
    $stSql .= "     el.logotipo                                     \n";
    $stSql .= " FROM                                                \n";
    $stSql .= "     ".$this->getTabela()."  AS ENT                  \n";
    $stSql .= " LEFT OUTER JOIN                                     \n";
    $stSql .= "     orcamento.entidade_logotipo AS el               \n";
    $stSql .= " ON                                                  \n";
    $stSql .= "     ENT.cod_entidade     = el.cod_entidade AND      \n";
    $stSql .= "     ENT.exercicio        = el.exercicio,            \n";
    $stSql .= "     sw_cgm                 AS CGM,                  \n";
    $stSql .= "     sw_cgm                 AS RESP,                 \n";
    $stSql .= "     sw_cgm                 AS RESPTEC               \n";
    $stSql .= " WHERE                                               \n";
    $stSql .= "     ENT.numcgm           = CGM.numcgm       AND     \n";
    $stSql .= "     ENT.cod_responsavel  = RESP.numcgm      AND     \n";
    $stSql .= "     ENT.cod_resp_tecnico = RESPTEC.numcgm   AND     \n";
