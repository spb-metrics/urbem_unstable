...
function listarSuplementacao(&$rsLista, $stOrder = "", $boTransacao = "")
{
    ...
    if( $this->obROrcamentoDespesa->getCodDespesa() )
        $stFiltro .= " OSS.cod_despesa = ".$this->obROrcamentoDespesa->getCodDespesa(). " AND";
    ...
    if ($this->inSituacao == '2') {
        ...
        $stFiltro .= "                FROM orcamento.suplementacao_anulada o_sa \n";
        $stFiltro .= "               WHERE o_sa.cod_suplementacao = OS.cod_suplementacao \n";
        $stFiltro .= "                 AND o_sa.exercicio = '".$this->stExercicio."' \n";
        $stFiltro .= "            ) \n";
        $stFiltro .= " AND";
//         $stFiltro .= " OS.cod_suplementacao NOT IN ( select cod_suplementacao from orcamento.suplementacao_anulada where exercicio = '".$this->stExercicio."' ) AND";
        ...
        $stFiltro .= "            ) \n";
        $stFiltro .= " AND";
//         $stFiltro .= " OS.cod_suplementacao IN ( select cod_suplementacao from orcamento.suplementacao_anulada where exercicio = '".$this->stExercicio."' ) AND";
    }
