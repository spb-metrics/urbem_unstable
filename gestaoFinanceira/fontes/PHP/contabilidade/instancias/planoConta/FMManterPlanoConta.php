...
$stFiltroEntidade = " AND entidade.cod_entidade = ".Sessao::getCodEntidade()." AND entidade.exercicio = '".Sessao::getExercicio()."'";
...
$obHdnEval->setValue("
                ...
                if ( document.getElementById('stTipoConta').value == 'A' && document.getElementById('boContaBanco').checked == true ) {
                    ...
                    if (document.getElementById('inCodRecurso')) {
                        if (document.getElementById('inCodRecurso').value == '') {
                            mensagem = 'Informe um recurso.';
                            erro = true;
                        }
                    } else { // Destinação
                        if (document.getElementById('stDestinacaoRecurso').value == '') {
                            mensagem = 'Defina a Destinação de Recurso';
                            erro = true;
                        }
