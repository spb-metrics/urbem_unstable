...
/**
    ...
    * @access Private
*/
function TContabilidadePlanoAnaliticaCredito()
{
    parent::Persistente();
...
/*
    ...
    $stSql .= "	where tbl.cod_credito = " . $this->getDado('cod_credito') ."
                                ...
                                and tbl.cod_natureza = " . $this->getDado('cod_natureza') ."
                       ";
  // e que sejam diferentes do plano em questao
    $stSql .= "   and tbl.cod_plano != " . $this->getDado( "codigo" );
    $stSql .= "   and tbl.exercicio = " . $this->getDado( "exercicio" );
*/
