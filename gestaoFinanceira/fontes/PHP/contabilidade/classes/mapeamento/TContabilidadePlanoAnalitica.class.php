...
/**
    ...
    * @access Private
*/
function TContabilidadePlanoAnalitica()
{
    parent::Persistente();
...
function montaRecuperaRelacionamentoRecurso()
{
    ...
    $stSQL .="         WHERE                                            \n";
    $stSQL .="             pr.cod_recurso  = r.cod_recurso AND          \n";
    $stSQL .="             pr.exercicio    = r.exercicio                \n";
    $stSQL .="     ) as pr on (                                         \n";
    $stSQL .="         pa.cod_plano = pr.cod_plano and                  \n";
    $stSQL .="         pa.exercicio = pr.exercicio                      \n";
    $stSQL .="     )                                                    \n";
