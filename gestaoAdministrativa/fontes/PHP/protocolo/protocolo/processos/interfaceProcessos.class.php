            ...
            function Salvar()
            {
                ...
                if (Valida()) {
                    if (exercicio == '') {
                        ...
                        varsGet += '&stDescQuestao=<?php echo urlencode( "Deseja encaminhar este processo para o setor selecionado?");?>';
    ...
    <script language="JavaScript">
            ...
            function Salvar()
            {
                ...
                if (Valida()) {
                    ...
                    varsGet += '&stDescQuestao=<?php echo urlencode( "Deseja encaminhar estes processos para o setor selecionado?");?>';
