 ...
 *
 * $Id: receitaCapital.plsql 62751 2015-06-16 14:44:45Z michel $
*/
            ...
            FROM(                    
                    SELECT 
                            ...
                            ,( SELECT (totais.tabela1 - totais.tabela2)::varchar as valor
                                 FROM (
                                       SELECT ( SELECT COALESCE(SUM(valor_previsto),0.00) as valor 
                                                  FROM tmp_balancete_receita 
                    ...
                    SELECT
                            ...
                            ,( SELECT (totais.tabela1 - totais.tabela2)::varchar as valor
                                 FROM (
                                       SELECT ( SELECT COALESCE(SUM(arrecadado_periodo *-1 ),0.00) as valor 
                                                  FROM tmp_balancete_receita 
                                                 WHERE cod_estrutural LIKE ''2.3%'' 
                                              ) AS tabela1
                                            ,
