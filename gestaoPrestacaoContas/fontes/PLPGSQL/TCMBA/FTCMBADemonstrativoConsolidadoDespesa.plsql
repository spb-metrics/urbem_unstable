...
*
* $Id: FTCMBADemonstrativoConsolidadoDespesa.plsql 63143 2015-07-29 14:37:54Z carlos.silva $
*
        ...
        stSql := 'CREATE TEMPORARY TABLE tmp_relacao AS
                ...
                FROM
                 ...
                 (
                  ...
                  SUM(Case When os.cod_tipo = 12 OR os.cod_tipo = 13 OR os.cod_tipo = 14 Then
                                   oss1.valor
                ...
                stSql := stSql || '
                  ...
                  ON ( od.cod_despesa = oss.cod_despesa and od.exercicio = oss.exercicio )
            ...
            LEFT JOIN
                ...
                stSql := stSql || '
                         ...
                         group by oss1.exercicio,oss1.cod_despesa) as oss_mes

                  ON ( od.cod_despesa = oss_mes.cod_despesa and od.exercicio = oss_mes.exercicio )
                       
                  LEFT JOIN
                    (select cod_despesa,max(osr1.exercicio) as exercicio,
                    
                            SUM(Case When os.cod_tipo != 12 AND os.cod_tipo != 13 AND os.cod_tipo != 14 Then
                                   valor
                           Else 0 End) as valor,
                ...
                AND EXISTS ( SELECT 1
                    ...
                    ON( od.cod_despesa = osr.cod_despesa AND od.exercicio = osr.exercicio)
                ...
                stSql := stSql || '
                  AND EXISTS ( SELECT 1
                    ...
                    ON( od.cod_despesa = osr_mes.cod_despesa AND od.exercicio = osr_mes.exercicio)
