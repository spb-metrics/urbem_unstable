 ...
 *
 * $Id: receitaCorrente.plsql 62479 2015-05-13 19:07:11Z arthur $
*/
...
BEGIN
    ...
    stSql := ' SELECT cod_estrutural
                    , COALESCE( valor_previsto, 0)      AS valor_previsto 
                    , COALESCE( arrecadado_periodo, 0 ) AS arrecadado_periodo
                    , COALESCE( arrecadado_ano, 0 )     AS arrecadado_ano
