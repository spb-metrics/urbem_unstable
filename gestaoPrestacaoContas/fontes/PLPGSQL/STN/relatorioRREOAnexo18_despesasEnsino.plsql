...
--    vlReceitaBruta    := 
    ...
    SELECT SUM(ate_bi)
      ...
      FROM stn.fn_rreo_anexo10_despesas_novo(stExercicio,stEntidades, 1, inBimestre) AS tbl
           (
              grupo INTEGER
            , nivel INTEGER
            , descricao VARCHAR
    ...
    SELECT SUM(ate_bi)
      ...
      FROM stn.fn_rreo_anexo10_despesas_novo(stExercicio, stEntidades, 2, inBimestre) AS tbl
           (
              grupo INTEGER
            , nivel INTEGER
            , descricao VARCHAR
