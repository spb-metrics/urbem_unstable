...
/**
    ...
    *
    $Id: TTCEALAlteracaoOrcamentaria.class.php 59612 2014-09-02 12:00:51Z gelson $
    *
    * @ignore
    *
*/
    ...
    {       
        $stSql = "
                    ...
                    FROM ( SELECT
                                  ...
                                  , to_char(norma.dt_assinatura,'dd/mm/yyyy') AS dt_doc_alteracao
                                  ...
                                  , CASE WHEN norma.cod_tipo_norma=1
                                         THEN tceal.fn_retorno_atributo_normas(norma.cod_tipo_norma,norma.cod_norma,'Data de Publicação da Lei')
                                         ELSE to_char(norma.dt_publicacao,'dd/mm/yyyy')                                           
