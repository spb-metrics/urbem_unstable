...
/**
    ...
    *
    $Id: TTCEALReceitaArrecadada.class.php 60653 2014-11-06 13:03:30Z lisiane $
    *
    * @ignore
    *
*/
        ...
        $stSql ="
                SELECT               
                        ...
                        ,CASE WHEN cod_conta_contabil ilike '621310100000000' THEN 
                                LPAD(REPLACE(cod_estrutural, '.', ''),14,'0')
                        ELSE
                                cod_conta_receita
                ...
                FROM (
                    SELECT               
                        ...
                        , REPLACE(conta_receita.cod_estrutural, '.', '') as cod_conta_receita
