 ...
 * @subpackage Mapeamento
 ...
 $Id: TTCEALTransferencias.class.php 59612 2014-09-02 12:00:51Z gelson $
    ...
    {	
        $stSql = "
            SELECT
                ...
                , REPLACE(plano_conta_debito.cod_estrutural,'.','') AS cod_conta_balancete_debitada
                , (SELECT num_banco FROM monetario.banco WHERE banco.cod_banco = plano_banco_debito.cod_banco) AS cod_banco_conta_debitada
                , (SELECT num_agencia FROM monetario.agencia WHERE agencia.cod_banco = plano_banco_debito.cod_banco AND agencia.cod_agencia = plano_banco_debito.cod_agencia) AS cod_agencia_banco_conta_debitada
                ...
                , REPLACE(plano_conta_credito.cod_estrutural,'.','') AS cod_conta_balancete_credito
                ...
                , (SELECT num_agencia FROM monetario.agencia WHERE agencia.cod_banco = plano_banco_credito.cod_banco AND agencia.cod_agencia = plano_banco_credito.cod_agencia) as cod_agencia_banco_conta_credito
