    ...
    {       
        $stSql = "
                    ...
                    FROM ( SELECT empenho.cod_empenho
                                  ...
                                  , '+' AS sinal
                                  , CASE WHEN tipo_empenho.cod_tipo = 2 THEN 'Global'
                                         WHEN tipo_empenho.cod_tipo = 3 THEN 'Estimado'
                                         WHEN tipo_empenho.cod_tipo = 1 THEN 'Ordinário'
                                    END AS tipo
