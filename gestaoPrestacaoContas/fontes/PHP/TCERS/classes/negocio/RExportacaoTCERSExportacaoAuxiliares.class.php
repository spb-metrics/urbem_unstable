    ...
    public function geraRecordSet(&$arRecordSet , $stOrder = "")
    {
        ...
        if (in_array("UNIORCAM.TXT",$this->getArquivosSelecionados())) {
            ...
            if ($tamanhoEntidasSelecionadas <= 1) {
              ...
              $pegadado1 = pegaDado("parametro","administracao.configuracao","where parametro ilike 'cod_entidade_prefeitura' and exercicio = '".Sessao::getExercicio()."'");
              $pegadado2 = pegaDado("parametro","administracao.configuracao","where parametro ilike 'cod_entidade_rpps' and exercicio = '".Sessao::getExercicio()."'");
