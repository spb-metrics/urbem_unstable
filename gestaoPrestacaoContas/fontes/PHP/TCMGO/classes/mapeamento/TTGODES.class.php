...
*/
    ...
    INNER JOIN  orcamento.pao
     ...
     LEFT JOIN  (
      ...
      GROUP BY  despesa.cod_programa, despesa.cod_despesa, despesa.num_orgao, despesa.num_unidade, despesa.cod_funcao, despesa.cod_subfuncao, cod_natureza, numero_pao, pao.nom_pao
        ";
    ...
    INNER JOIN  (   SELECT  SUM(receita.vl_original) AS vl_total
         ...
         WHERE  despesa.exercicio = '".$this->getDado('exercicio')."'
           AND  despesa.cod_entidade IN (".$this->getDado('cod_entidade').")
      GROUP BY  despesa.cod_programa , despesa.cod_despesa, despesa.num_orgao, despesa.num_unidade, despesa.cod_funcao, despesa.cod_subfuncao, cod_natureza, numero_pao, elemento_despesa
        ";
    ...
    INNER JOIN  (   SELECT  SUM(receita.vl_original) AS vl_total
         ...
         WHERE  despesa.exercicio = '".$this->getDado('exercicio')."'
           AND  despesa.cod_entidade IN (".$this->getDado('cod_entidade').")
      GROUP BY  despesa.cod_programa , despesa.cod_despesa, despesa.num_orgao, despesa.num_unidade, despesa.cod_funcao, despesa.cod_subfuncao, cod_natureza, numero_pao, elemento_despesa, recurso.codigo_tc, fonte_recurso.descricao
    ";
