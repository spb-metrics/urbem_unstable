...
public function montaRecupera10()
{
        $stSql  = " SELECT '10' AS tiporegistro
                            ...
                            ,unidade_responsavel.num_unidade AS cod_unidadesub
                            ,homologacao.exercicio_licitacao
                            ,homologacao.exercicio_licitacao || LPAD(homologacao.cod_entidade::VARCHAR,2,'0') || LPAD(homologacao.cod_modalidade::VARCHAR,2,'0') || LPAD(homologacao.cod_licitacao::VARCHAR,4,'0')
                            AS nro_processolicitatorio
                    ...
                    JOIN orcamento.unidade
                      ON unidade.exercicio = licitacao.exercicio
                     AND unidade.num_unidade = licitacao.num_unidade
                     AND unidade.num_orgao = licitacao.num_orgao
...
public function recupera30(&$rsRecordSet, $boTransacao = "")
    {
        ...
        $stGroup = " GROUP BY 1,2,3,4,5,6,7,8,9
                    ";
