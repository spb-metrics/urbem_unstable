...
class TTCMGOAberturaLicitacao extends Persistente
{
    /**
        ...
        * @access Private
    */
    function TTCMGOAberturaLicitacao()
    {
        parent::Persistente();
    }

    function recuperaExportacao10(&$rsRecordSet, $stFiltro = "", $stOrdem = "", $boTransacao = "")
    {
        $obErro      = new Erro;
    ...
    function recuperaExportacao12(&$rsRecordSet, $stFiltro = "", $stOrdem = "", $boTransacao = "")
    {
        $obErro      = new Erro;
        $obConexao   = new Conexao;
        $rsRecordSet = new RecordSet;
    ...
    function recuperaExportacao13(&$rsRecordSet, $stFiltro = "", $stOrdem = "", $boTransacao = "")
    {
        $obErro      = new Erro;
        $obConexao   = new Conexao;
        $rsRecordSet = new RecordSet;
