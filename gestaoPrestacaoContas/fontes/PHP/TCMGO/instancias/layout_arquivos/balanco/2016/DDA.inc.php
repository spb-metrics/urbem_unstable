...
/**
  ...
  * @ignore
  * $Id: DDA.inc.php 65168 2016-04-29 16:36:09Z michel $
*/
...
$obTTCMGOConfiguracaoUnidadeGestora->setDado('cod_entidade',Sessao::getCodEntidade());
$obTTCMGOConfiguracaoUnidadeGestora->recuperaUnidadeGestora($rsUnidadeGestora, "", "", $obTransacao);
...
$obTTCMGODDA->recuperaArquivoExportacao10($rsRegistro10, "", "", $obTransacao);
