...
<?php
    ...
    foreach ($rsRegistro1->arElementos as $arRegistro1) {
        ...
        $stChave1 = $arRegistro1['processo_origem'];
        ...
        foreach ($rsRegistro2->arElementos as $arRegistro2) {
            ...
            if ($stChave1 === $arRegistro2['processo_origem']) {
                ...
                $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("nom_locatario");
                $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
                $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(50);
            ...
            foreach ($rsRegistro3->arElementos as $arRegistro3) {
                ...
                if ($stChave1 === $arRegistro3['processo_origem']) {
            ...
            foreach ($rsRegistro4->arElementos as $arRegistro4) {
                if ($stChave1 === $arRegistro4['processo_origem']) {
