...
Revision 1.1  2007/09/11 03:14:28  diego
Primeira versão.
...
include_once ( CAM_GPC_TCMBA_MAPEAMENTO ."TTBATipoCertidao.class.php" );

SistemaLegado::BloqueiaFrames();

//Define o nome dos arquivos PHP
$stPrograma = "ManterTipoCertidao";
...
$obPersistente = new TTBATipoCertidao();

$obPersistente->recuperaRelacionamento($rsRecordSetLista);
$obPersistente->obTLicitacaoDocumento->recuperaTodos($rsRecordSetCombo,' ORDER BY cod_documento');
...
$obLista->addCabecalho();
$obLista->ultimoCabecalho->addConteudo( "Tipo de Certidão - TCM" );
$obLista->ultimoCabecalho->setWidth( 67 );
$obLista->commitCabecalho();
$obLista->addCabecalho();
$obLista->ultimoCabecalho->addConteudo( "Documentos Exigidos - Sistema" );
...
$obCmbCombo->setCampoId       ("cod_documento"              );
$obCmbCombo->setCampoDesc     ("[cod_documento] - [nom_documento]"    );
$obCmbCombo->preencheCombo    ($rsRecordSetCombo            );
$obCmbCombo->setNull          ( false                       );
$obCmbCombo->setValue         ("cod_documento");
