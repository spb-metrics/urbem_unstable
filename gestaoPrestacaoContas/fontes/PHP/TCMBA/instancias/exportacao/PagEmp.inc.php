...
*/
    ...
    include_once( CAM_GPC_TCMBA_MAPEAMENTO."TTBAPagamento.class.php" );
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("[]"); //conta_pagadora 2
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(34);
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("[]"); //conta_pagadora 3
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(34);
