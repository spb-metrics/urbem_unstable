...
$obPersistente = new TTBATipoVeiculo();

$obPersistente->recuperaRelacionamento($rsRecordSetLista);
$obPersistente->obTFrotaTipoVeiculo->recuperaTodos($rsRecordSetCombo,' ORDER BY cod_tipo');

// SistemaLegado::mostravar($rsRecordSetLista);
// SistemaLegado::mostravar($rsRecordSetCombo);

$obLista = new Lista;
$obLista->setTitulo ( "Relacionamento com Tipos de Veiculo-TCMBA");
...
$obLista->addCabecalho();
$obLista->ultimoCabecalho->addConteudo( "Tipo de Veiculo - TCM" );
$obLista->ultimoCabecalho->setWidth( 67 );
$obLista->commitCabecalho();
$obLista->addCabecalho();
$obLista->ultimoCabecalho->addConteudo( "Tipo de Veiculo - Sistema" );
...
$obCmbCombo->setCampoId       ("cod_tipo"                   );
$obCmbCombo->setCampoDesc     ("[cod_tipo] - [nom_tipo]"    );
