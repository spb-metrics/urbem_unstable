...
Revision 1.1  2007/09/04 00:33:15  diego
Primeira versão.
...
$obPersistente = new TTBATipoCombustivel();

$obPersistente->recuperaRelacionamento($rsRecordSetLista);
$obPersistente->obTFrotaCombustivel->recuperaTodos($rsRecordSetCombo,' ORDER BY cod_combustivel');

// SistemaLegado::mostravar($rsRecordSetLista);
// SistemaLegado::mostravar($rsRecordSetCombo);

$obLista = new Lista;
$obLista->setTitulo ( "Relacionamento com Tipos de Combustivel-TCMBA");
...
$obLista->addCabecalho();
$obLista->ultimoCabecalho->addConteudo( "Tipo de Combustivel - TCM" );
$obLista->ultimoCabecalho->setWidth( 67 );
$obLista->commitCabecalho();
$obLista->addCabecalho();
$obLista->ultimoCabecalho->addConteudo( "Tipo de Combustivel - Sistema" );
...
$obCmbCombo->setCampoId       ("cod_combustivel"                   );
$obCmbCombo->setCampoDesc     ("[cod_combustivel] - [nom_combustivel]"    );
$obCmbCombo->preencheCombo    ($rsRecordSetCombo            );
$obCmbCombo->setNull          ( false                       );
$obCmbCombo->setValue         ("cod_combustivel");

$obLista->addDadoComponente( $obCmbCombo );
$obLista->ultimoDado->setCampo( "cod_combustivel" );
