...
$obPersistente->obTFrotaMarca->recuperaTodos($rsRecordSetCombo,' ORDER BY cod_marca');

// SistemaLegado::mostravar($rsRecordSetLista);
// SistemaLegado::mostravar($rsRecordSetCombo);

$obLista = new Lista;
$obLista->setTitulo ( "Relacionamento com Marcas-TCMBA");
...
$obLista->commitCabecalho();
$obLista->addDado();
$obLista->ultimoDado->setCampo( "[cod_marca_tcm] - [descricao]" );
$obLista->ultimoDado->setAlinhamento( 'ESQUERDA' );
$obLista->commitDado();

$obCmbCombo = new Select();
$obCmbCombo->setName          ("inMarca_[cod_marca_tcm]_"   );
