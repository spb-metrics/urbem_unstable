...
/**
  ...
  *
  * $Id: TTCMBATipoConciliacaoLancamentoContabil.class.php 65087 2016-04-22 14:27:07Z carlos.silva $
  * $Revision: $
  * $Author: $
  * $Date: $
*/
...
class TTCMBATipoConciliacaoLancamentoContabil extends Persistente {
    ...
    {
        parent::Persistente();
        $this->setTabela('tcmba.tipo_conciliacao_lancamento_contabil');
