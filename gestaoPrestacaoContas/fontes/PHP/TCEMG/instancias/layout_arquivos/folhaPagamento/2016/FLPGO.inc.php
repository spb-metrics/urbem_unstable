...
$obTTCEMGArquivoFolhaPagamento->setDado('cod_entidade'             , $arFiltro['inCodEntidade'] );
$obTTCEMGArquivoFolhaPagamento->setDado('mes'                      , $inMes );

$obTTCEMGArquivoFolhaPagamento->recuperaDadosExportacaoFolhaPagamento10($rsRecordSet10);

$obTTCEMGArquivoFolhaPagamento->recuperaDadosExportacaoFolhaPagamento11($rsRecordSet11);
