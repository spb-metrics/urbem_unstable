...
<?php
    ...
    */
    ...
    include_once( CAM_GPC_TCEMG_MAPEAMENTO.'FTCEMGDespesaPrev.class.php');
    ...
    $obFTCEMGDespesaPrev->setDado('dt_inicial'   , $dtPeriodoInicial                                   );
    $obFTCEMGDespesaPrev->setDado('dt_final'     , $dtPeriodoFinal                                     );
    $obFTCEMGDespesaPrev->recuperaTodos($rsRecordSet);

    while (!$rsRecordSet->EOF()) {
        $rsRecordSet->setCampo('mes', $stMes);
        $rsRecordSet->proximo();
    }
