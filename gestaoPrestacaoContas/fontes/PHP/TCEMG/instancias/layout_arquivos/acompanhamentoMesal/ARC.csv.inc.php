...
$obTOrcamentoReceita->setDado('entidades' , $stEntidades);
$obTOrcamentoReceita->setDado('exercicio' , Sessao::getExercicio());
$obTOrcamentoReceita->setDado('mes'       , $stMes);

//Tipo Registro 10
$obTOrcamentoReceita->recuperaCorrecoesReceitas10($rsRecordSetARC10);

//Tipo Registro 11
$obTOrcamentoReceita->recuperaCorrecoesReceitas11($rsRecordSetARC11);
 ...
 *  
 *  $obTOrcamentoReceita->recuperaCorrecoesReceitas12($rsRecordSetARC12);
*/ 

//Tipo Registro 20
$obTOrcamentoReceita->recuperaCorrecoesReceitas20($rsRecordSetARC20);

//Tipo Registro 21
$obTOrcamentoReceita->recuperaCorrecoesReceitas21($rsRecordSetARC21);
...
if (count($rsRecordSetARC10->getElementos()) > 0) {
    $boArc = true;
    $inCount=0;
