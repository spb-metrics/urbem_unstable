...
/**
  ...
  *
  * @ignore
  * $Id: HABLIC.csv.inc.php 59719 2014-09-08 15:00:53Z franver $
...
*/
include_once CAM_GPC_TCEMG_MAPEAMENTO."TTCEMGHabilitacaoLicitacao.class.php";
...
if ( count($rsRecordSetHABLIC10->getElementos()) > 0) {
    ...
    foreach ($rsRecordSetHABLIC10->getElementos() as $arHABLIC10) {
        ...
        if($arHABLIC10['natureza_objeto']!=99){   
            $stChave10 = $arHABLIC10['cod_orgao'].$arHABLIC10['cod_unidade'].$arHABLIC10['exercicio_licitacao'].$arHABLIC10['num_processo_licitatorio'];
            ...
            foreach ($rsRecordSetHABLIC11->getElementos() as $arHABLIC11) {
                $inCount++;
                $stChave11 = $arHABLIC11['cod_orgao'].$arHABLIC11['cod_unidade'].$arHABLIC11['exercicio_licitacao'].$arHABLIC11['num_processo_licitatorio'];
