...
/**
  ...
  *
  * @ignore
  * $Id: ALQ.csv.inc.php 59719 2014-09-08 15:00:53Z franver $
...
*/
include_once CAM_GPC_TCEMG_MAPEAMENTO."TTCEMGALQ.class.php";
...
if (count($rsRecordSetALQ10->getElementos()) > 0) {
    ...
    foreach ($rsRecordSetALQ10->getElementos() as $arALQ10) {
        ...
        $arALQ10['cod_reduzido']=$arALQ10['cod_reduzido'].$arALQ10['num_liquidacao'];
        ...
        if ($boDiferente) {
            ...
            $inCount++;
            $stChave = $arALQ10['num_empenho'].$arALQ10['num_liquidacao'];
            ...
            if (count($rsRecordSetALQ11->getElementos()) > 0) {
                ...
                foreach ($rsRecordSetALQ11->getElementos() as $arALQ11) {
                    if ($stChave11 <> $arALQ11['tipo_registro'].$arALQ11['cod_reduzido'].$arALQ11['cod_fonte_recurso'].$arALQ11['num_empenho']) {
                        $stChaveElemento = $arALQ11['num_empenho'].$arALQ11['num_liquidacao'];
                        $stChave11 = $arALQ11['tipo_registro'].$arALQ11['cod_reduzido'].$arALQ11['cod_fonte_recurso'].$arALQ11['num_empenho'];
                        $arALQ11['cod_reduzido']=$arALQ11['cod_reduzido'].$arALQ11['num_liquidacao'];
    ...
    if (count($rsRecordSetALQ12->getElementos()) > 0) {
        ...
        $obExportador->roUltimoArquivo->setTipoDocumento('TCE_MG');
        $obExportador->roUltimoArquivo->addBloco($rsRecordSetALQ12);
