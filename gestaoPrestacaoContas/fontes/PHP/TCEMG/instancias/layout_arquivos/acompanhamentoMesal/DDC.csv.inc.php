...
/**
  ...
  *
  * @ignore
  * $Id: DDC.csv.inc.php 59719 2014-09-08 15:00:53Z franver $
...
$obTTCEMGConfiguracaoDDC->setDado('exercicio'     , Sessao::getExercicio());
$obTTCEMGConfiguracaoDDC->setDado('cod_entidade'  , $stEntidades);
$obTTCEMGConfiguracaoDDC->setDado('mes_referencia', $stMes);
 
$obTTCEMGConfiguracaoDDC->recuperaDadosMensalDDC10($rsRecordSetDDC10,$boTransacao);
 
$obTTCEMGConfiguracaoDDC->recuperaDadosMensalDDC20($rsRecordSetDDC20,$boTransacao);
 
$obTTCEMGConfiguracaoDDC->recuperaDadosMensalDDC30($rsRecordSetDDC30,$boTransacao);
