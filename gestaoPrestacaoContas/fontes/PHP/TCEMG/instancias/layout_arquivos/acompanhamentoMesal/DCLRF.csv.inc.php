...
/**
  ...
  *
  * @ignore
  * $Id: DCLRF.csv.inc.php 59719 2014-09-08 15:00:53Z franver $
...
$obTTCEMGConfiguracaoArquivoDCLRF->setDado('exercicio',Sessao::getExercicio());
$obTTCEMGConfiguracaoArquivoDCLRF->setDado('mes_referencia',$stMes);
$obTTCEMGConfiguracaoArquivoDCLRF->setDado('cod_orgao',$rsAdminConfigEntidade->getCampo('valor'));
$obTTCEMGConfiguracaoArquivoDCLRF->recuperaValoresArquivoDCLRF($rsRecordSetDCLRF10);
...
$obTTCEMGConfiguracaoArquivoDCLRF = null;
?>