...
<?php
    ...
    */
    ...
    include_once( CAM_GPC_TCEMG_MAPEAMENTO . 'FTCEMGDespesaCapital.class.php');

    $arFiltros = Sessao::read('filtroRelatorio');

    $obFTCEMGDespesaCapital = new FTCEMGDespesaCapital();
    $obFTCEMGDespesaCapital->setDado('exercicio'   , Sessao::read('exercicio'));
    $obFTCEMGDespesaCapital->setDado('cod_entidade', implode(',',$arFiltros['inCodEntidadeSelecionado']));
    $obFTCEMGDespesaCapital->setDado('mes'         , $arFiltros['inPeriodo']);

    $obFTCEMGDespesaCapital->recuperaTodos($rsArquivo);
    $obFTCEMGDespesaCapital->debug();
