    ...
    public function montaRecuperaExportacao10()
    {
        $stSql = "
                   SELECT 10 AS tipo_registro
                        ...
                        , licitacao.exercicio_processo::INTEGER AS exercicio_processo
                        , licitacao.exercicio::VARCHAR || LPAD(licitacao.cod_entidade::VARCHAR,2,'0') || LPAD(licitacao.cod_modalidade::VARCHAR,2,'0') || LPAD(licitacao.cod_licitacao::VARCHAR,4,'0') AS num_processo
