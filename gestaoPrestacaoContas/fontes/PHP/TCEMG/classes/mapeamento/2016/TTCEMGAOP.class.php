...
/**
    ...
    * @author Desenvolvedor: Carlos Adriano
    ...
    $Id: TTCEMGAOP.class.php 64292 2016-01-11 12:05:59Z michel $
        ...
        $stSql  = "    
            SELECT  '11' AS tiporegistro
                    ...
                    , CASE WHEN resultado_pagamento.pagamento = '3' OR resultado_pagamento.pagamento = '4'
                                  THEN CASE WHEN TO_CHAR(nota_liquidacao.dt_liquidacao, 'yyyy')::INTEGER < ".$this->getDado('exercicio')." AND TO_CHAR(nota_liquidacao_paga.timestamp,'yyyy')::INTEGER = ".$this->getDado('exercicio')."
                                                 THEN '3'
                                            WHEN TO_CHAR(nota_liquidacao.dt_liquidacao, 'yyyy')::INTEGER = ".$this->getDado('exercicio')." AND TO_CHAR(nota_liquidacao_paga.timestamp,'yyyy')::INTEGER = ".$this->getDado('exercicio')."
                                                 THEN '4'
                                                 ELSE resultado_pagamento.pagamento
                                       END
                                  ELSE CASE WHEN TO_CHAR(nota_liquidacao.dt_liquidacao, 'yyyy')::INTEGER < ".$this->getDado('exercicio')." AND TO_CHAR(nota_liquidacao_paga.timestamp,'yyyy')::INTEGER = ".$this->getDado('exercicio')."
                                                 THEN '3'
                                            WHEN TO_CHAR(empenho.dt_empenho, 'yyyy')::INTEGER < ".$this->getDado('exercicio')." AND TO_CHAR(nota_liquidacao.dt_liquidacao, 'yyyy')::INTEGER = ".$this->getDado('exercicio')." AND TO_CHAR(nota_liquidacao_paga.timestamp,'yyyy')::INTEGER = ".$this->getDado('exercicio')."
                                                 THEN '4'
                                                 ELSE resultado_pagamento.pagamento
                                       END
         ...
         INNER JOIN (SELECT restos_pre_empenho.cod_pre_empenho
