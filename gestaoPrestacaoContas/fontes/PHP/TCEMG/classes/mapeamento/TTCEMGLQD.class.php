                    ...
                    SELECT *
                     FROM (
                            SELECT
                                  ...
                                  , empenho.cod_empenho AS num_empenho
                                  , TO_CHAR(empenho.dt_empenho,'ddmmyyyy') AS dt_empenho
                                  , TCEMG.numero_nota_liquidacao('2014',empenho.cod_entidade,nota_liquidacao.cod_nota,nota_liquidacao.exercicio_empenho,empenho.cod_empenho) AS num_liquidacao
