            ...
            $stSql .= "            
                         ...
                         , ( SELECT atributo_norma_valor.valor
                              ...
                              WHERE atributo_tipo_norma.ativo = TRUE
                                ...
                                AND atributo_norma_valor.cod_norma = norma.cod_norma ) AS artigo_lei_alteracao
                         , ( SELECT atributo_norma_valor.valor
                               FROM normas.atributo_norma_valor
                               JOIN normas.atributo_tipo_norma
                                 ON atributo_tipo_norma.cod_tipo_norma = atributo_norma_valor.cod_tipo_norma
                               ...
                               JOIN administracao.atributo_dinamico
                                ...
                                AND atributo_dinamico.cod_atributo   = atributo_tipo_norma.cod_atributo  
                              WHERE atributo_tipo_norma.ativo = TRUE
                                AND atributo_dinamico.nom_atributo ILIKE 'Descrição do Artigo'
                                AND atributo_norma_valor.cod_norma = norma.cod_norma ) AS descricao_artigo
                    FROM orcamento.suplementacao
    ...
    public function montaRecuperaExportacao20()
    {
        $stSql = "
                    SELECT
                            '20' AS tipo_registro
                            , LPAD(configuracao_entidade.valor::VARCHAR,2,'0') AS cod_orgao
                            , norma.num_norma AS nro_lei_alter_orcam
                            , TO_CHAR(norma.dt_assinatura,'ddmmyyyy') AS dt_lei_alter_orcam
           ...
           SELECT '21' AS tipo_registro
                ...
                , ( SELECT atributo_norma_valor.valor
                     ...
                     WHERE atributo_tipo_norma.ativo = TRUE
                       ...
                       AND atributo_norma_valor.cod_norma = norma.cod_norma ) AS artigo_lei_alter_orcamento
                , ( SELECT atributo_norma_valor.valor
                      FROM normas.atributo_norma_valor
                      JOIN normas.atributo_tipo_norma
                        ON atributo_tipo_norma.cod_tipo_norma = atributo_norma_valor.cod_tipo_norma
                      ...
                      JOIN administracao.atributo_dinamico
                       ...
                       AND atributo_dinamico.cod_atributo   = atributo_tipo_norma.cod_atributo  
                     WHERE atributo_tipo_norma.ativo = TRUE
                       AND TRIM(atributo_dinamico.nom_atributo) ILIKE 'Descrição do Artigo'
                       AND atributo_norma_valor.cod_norma = norma.cod_norma ) AS descricao_artigo
                , COALESCE(( SELECT atributo_norma_valor.valor AS valor
                     ...
                     WHERE atributo_tipo_norma.ativo = TRUE
                       ...
                       AND atributo_norma_valor.cod_norma = norma.cod_norma ), '0.00') AS novo_percentual
                , ( SELECT atributo_norma_valor.valor
                      FROM normas.atributo_norma_valor
                      JOIN normas.atributo_tipo_norma
                        ON atributo_tipo_norma.cod_tipo_norma = atributo_norma_valor.cod_tipo_norma
