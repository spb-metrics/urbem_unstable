    ...
    */
    ...
    public function montaRecuperaDadosEMP10()
    {
        $stSql  = " SELECT DISTINCT ON(EE.cod_empenho)
                    ...
                    AS vlbruto
                    , REPLACE((REPLACE(EPE.descricao, Chr(10), '')), Chr(13), ' ') AS especificacaoempenho
			...
			END
			      ...
			      CASE  WHEN tipo_objeto.cod_tipo_objeto = 1 THEN
                    ...
                    LEFT JOIN tcemg.processo_adesao_registro_precos AS RegPreco
    ...
    */
    ...
    public function montaRecuperaDadosEMP12()
    {
        $stSql  = "
                ...
                WHERE (tabela.folha IS false AND (LENGTH(nroDocumento) > 0))
                   OR (tabela.folha IS true AND (LENGTH(nroDocumento) > 0) ) ";
