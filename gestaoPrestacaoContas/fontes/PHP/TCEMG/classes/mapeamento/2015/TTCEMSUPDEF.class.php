...
/**
    ...
    * @author Desenvolvedor: Michel Teixeira
    ...
    $Id: TTCEMSUPDEF.class.php 64204 2015-12-15 20:18:02Z michel $
    ...
    */
    ...
    public function montaRecuperaDadosSUPDEF10()
    {
        $stSql  = "    SELECT 10 AS tiporegistro
                            , superavit_deficit
                            , SUM(vl_apurado) AS vl_apurado
                         FROM (
                                SELECT CASE WHEN valor_ativo > valor_passivo
                                            THEN 'S'
