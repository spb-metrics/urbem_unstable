    ...
    public function montaRecuperaDadosExportacaoMensal()
    {
        $stSql = "
           SELECT
                ...
                , CASE WHEN (MAX(sw_cga.timestamp) <= TO_DATE('".$this->getDado('dtInicio')."','DD/MM/YYYY') ) 
                       THEN 2                        
                       ELSE 1 END AS tipo_cadastro
      ...
      LEFT JOIN sw_cga
          ...
          WHERE SW_CGM.numcgm > 0
            ...
            AND SW_CGM.dt_cadastro <= TO_DATE('".$this->getDado('dtFim')."','DD/MM/YYYY')
