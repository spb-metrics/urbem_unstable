...
if ($stAcao == "alterar" or $stAcao == "alterar_servidor") {
    ...
    ##############################################################################################################
    if($stAcao == "alterar")
        $inCodServidor = $_REQUEST["inCodServidor"];
    ...
    if ($stAcao == "alterar") {
        ...
        Sessao::write("inCodVinculo", $obRPessoalServidor->roUltimoContratoServidor->consultarVinculoDoServidor($_REQUEST["inCodContrato"]));
...
//$obFormulario->addComponente        ( $obBscLotacao                                                     );
...
if ( $request->get('actVoltar') ) {
    ...
    $hdnVoltar->setValue ( $_GET['actVoltar'] );
