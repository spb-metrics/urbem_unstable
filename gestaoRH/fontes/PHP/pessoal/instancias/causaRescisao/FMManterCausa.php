...
$stLink = $pgFilt."?".Sessao::getId()."&inCodCausa=".$_REQUEST['inCodCausa'];
...
$obRPessoalCausaRescisao->roUltimoPessoalCasoCausa->listarPeriodoRescisao($rsPeriodo);

if ($stAcao == "alterar") {
    $obTPessoalSefip = new TPessoalSefip();
    $stFiltro = " WHERE cod_sefip = ".$_GET['inCodSefipSaida'];
    ...
    $stFiltro = " AND cod_causa_rescisao = ".$_GET['inCodigoCausa'];
...
$obHdnCodCausa->setValue( $_REQUEST["inCodigoCausa"] );
...
$obTxtCodCausa->setValue         ( $_REQUEST["inNumCausa"]  );
...
$obTxtDescricaoCausa->setValue         ( $_REQUEST["stDescricaoCausa"]  );
