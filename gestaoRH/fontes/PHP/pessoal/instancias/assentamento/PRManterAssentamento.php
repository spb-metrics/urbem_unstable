...
/**
  ...
  * @author Programador: Vandré Miguel Ramos
    ...
    $Id: PRManterAssentamento.php 59612 2014-09-02 12:00:51Z gelson $
...
switch ($stAcao) {
    case "incluir":
        ...
        if ( $obErro->ocorreu() ) {
            ...
            $obRPessoalAssentamento->obRFolhaPagamentoPrevidencia->setCodRegimePrevidencia( $_POST['inCodRegimePrevidencia'] );
