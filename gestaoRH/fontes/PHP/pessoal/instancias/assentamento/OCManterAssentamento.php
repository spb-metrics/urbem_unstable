...
/**
    ...
    * @ignore
    $Id: OCManterAssentamento.php 59612 2014-09-02 12:00:51Z gelson $
...
function gerarSpanEventos2()
{
    ...
    $stEval  = $obFormulario->obJavaScript->getInnerJavaScript();
    $stEval  = str_replace("\n","",$stEval);
//     $stEval .="if (document.frm.boEventoAutomatico.checked == true) {                                  ";
//     $stEval .=" proporcionais = document.frm.inCodEventoProporcionalizacaoSelecionados;                                  ";
//     $stEval .=" integrais     = document.frm.inCodEventoSelecionados;                                                    ";
//     $stEval .=" if (proporcionais.length > 0 && integrais.length > 0) {                                                  ";
//     $stEval .="    lblIntegrais:                                                                                        ";
//     $stEval .="    for (i=0;i<proporcionais.length;i++) {                                                                 ";
//     $stEval .="        inCodigo1 = proporcionais[i].value;                                                              ";
//     $stEval .="        lblProporcionais:                                                                                ";
//     $stEval .="        for (j=0;j<integrais.length;j++) {                                                                 ";
//     $stEval .="            inCodigo2 = integrais[j].value;                                                              ";
//     $stEval .="            if (inCodigo1 == inCodigo2) {                                                                  ";
//     $stEval .="                erro = true;                                                                             ";
//     $stEval .="                mensagem += \"@Verifique os eventos proporcionais selecionados, estes devem ser diferentes dos eventos automáticos!()\";     ";
//     $stEval .="                break lblProporcionais;                                                                  ";
//     $stEval .="                break lblIntegrais;                                                                      ";
//     $stEval .="            }                                                                                            ";
//     $stEval .="        }                                                                                                ";
//     $stEval .="    }                                                                                                    ";
//     $stEval .=" }";
...
function preencheDataNormaSelecionada($boExecuta=false)
{
    ...
    if ($_REQUEST['stAcao'] != 'alterar') {
        if ( $rsNorma->getNumLinhas() == 1 ) {
            $stJs .="f.dtDataInicioAssentamento.value = '".$rsNorma->getCampo('dt_publicacao')."'; \n";
            $stJs .="f.dtDataInicio.value = '".$rsNorma->getCampo('dt_publicacao')."'; \n";
        } else {
            $stJs .="f.dtDataInicioAssentamento.value = ''; \n";
            $stJs .="f.dtDataInicio.value = ''; \n";
        }
...
function listarCorrecoes($arRecordSet, $boExecuta=false)
{
    ...
    if ($rsRecordSet->getNumLinhas() != 0) {
        ...
        $obLista->ultimaAcao->addCampo("1","inId");
//         $obLista->ultimaAcao->addCampo("2","inQuantidadeMeses");
//         $obLista->ultimaAcao->addCampo("3","nuPercentualCorrecao");
        $obLista->commitAcao();
...
function gerarSpanMotivo()
{
    ...
    if ($_POST["inCodMotivo"] == 9 or Sessao::read("inCodMotivo") == 9) {
        ...
        //$obTxtQuantDiasLicencaPremio->setMaxLength(30);
