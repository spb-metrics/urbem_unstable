...
/**
  ...
  * Data de criação : 09/06/2005
    ...
    * @author Programador: Vandré Miguel Ramos
    ...
    $Id: FMManterAssentamentoAbaAssentamento.php 59612 2014-09-02 12:00:51Z gelson $
...
$obRdoRegimePrevidencia1 = new Radio;
$obRdoRegimePrevidencia1->setName           ( "inCodRegimePrevidencia"                          );
$obRdoRegimePrevidencia1->setValue          ( 1                                                 );
$obRdoRegimePrevidencia1->setTitle          ( "Informe o regime da previdência."                );
$obRdoRegimePrevidencia1->setRotulo         ( "Regime da Previdência"                           );
$obRdoRegimePrevidencia1->setChecked        ( !$inCodRegimePrevidencia || $inCodRegimePrevidencia == 1 );
$obRdoRegimePrevidencia1->setLabel          ( "RGPS"                                            );

$obRdoRegimePrevidencia2 = new Radio;
$obRdoRegimePrevidencia2->setName           ( "inCodRegimePrevidencia"                          );
$obRdoRegimePrevidencia2->setValue          ( 2                                                 );
$obRdoRegimePrevidencia2->setTitle          ( "Informe o regime da previdência."                );
$obRdoRegimePrevidencia2->setRotulo         ( "Regime da Previdência"                           );
$obRdoRegimePrevidencia2->setChecked        ( $inCodRegimePrevidencia == 2                      );
$obRdoRegimePrevidencia2->setLabel          ( "RPPS"                                            );

$obLblRegimePrevidencia = new Label;
$obLblRegimePrevidencia->setRotulo          ( "Regime da Previdência"                           );
$obLblRegimePrevidencia->setName            ( "stRegimePrevidencia"                             );
$obLblRegimePrevidencia->setValue           ( $stRegimePrevidencia                              );
