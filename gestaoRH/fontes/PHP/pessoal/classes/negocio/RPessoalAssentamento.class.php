...
<?php
 /**
    ...
    * @subpackage Regra
    ...
    $Id: RPessoalAssentamento.class.php 59612 2014-09-02 12:00:51Z gelson $
...
function incluirAssentamento($boTransacao = "")
{
    ...
    if ( !$obErro->ocorreu() ) {
        ...
        $this->obTPessoalAssentamentoAssentamento->setDado("cod_regime_previdencia",$this->obRFolhaPagamentoPrevidencia->getCodRegimePrevidencia());
