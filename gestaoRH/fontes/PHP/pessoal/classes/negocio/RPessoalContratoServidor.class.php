...
function excluirContratoServidor($boTransacao = "")
{
    ...
    if ( !$obErro->ocorreu() ) {
        $this->excluirVaga( $boTransacao ); //alteracao das vagas do contrato
    }
    if ( !$obErro->ocorreu() ) {
        $tempComp = $obTPessoalServidorContratoServidor->getComplementoChave();
        $tempCod  = $obTPessoalServidorContratoServidor->getCampoCod();
        $obTPessoalServidorContratoServidor->setComplementoChave('');
        $obTPessoalServidorContratoServidor->setCampoCod('cod_contrato');
        ...
        $obTPessoalServidorContratoServidor->setComplementoChave($tempComp);
        $obTPessoalServidorContratoServidor->setCampoCod($tempCod);
    }
    if ( !$obErro->ocorreu() ) {
