...
class RPessoalPensao
{
   ...
   */
   ...
   public function addIncidencia($inCodIncidencia) { $this->arIncidencias[] = $inCodIncidencia; }
   ...
   */
   ...
   public function listarIncidenciasPensao(&$rsRecordSet, $inCodPensao, $stTimeStamp)
   {
       ...
       $stFiltro = " where cod_pensao = $inCodPensao and TO_CHAR(timestamp,'yyyy-mm-dd hh24:mi:ss.us') = '$stTimeStamp' ";
