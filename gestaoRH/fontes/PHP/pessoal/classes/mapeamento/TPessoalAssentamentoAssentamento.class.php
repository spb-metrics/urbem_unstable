...
/**
    ...
    * @subpackage Mapeamento
    ...
    $Id: TPessoalAssentamentoAssentamento.class.php 60247 2014-10-08 17:06:26Z michel $
...
function montaRecuperaRelacionamento()
{
    ...
    $stSql .= "   AND assentamento_assentamento.cod_regime_previdencia = previdencia.cod_regime_previdencia            \n";
    ...
    if (trim($this->getDado("dtInicial")) != "" && trim($this->getDado("dtFinal"))!="") {
        ...
        $stSql .= "                   AND assentamento_assentamento_interno.cod_regime_previdencia = previdencia.cod_regime_previdencia                                                         \n";
...
function montaRecuperaContratoAssentamentoSubDivisao()
{
    ...
    $stSQL .= "         ON assentamento_assentamento.cod_regime_previdencia = previdencia.cod_regime_previdencia                     \n";
