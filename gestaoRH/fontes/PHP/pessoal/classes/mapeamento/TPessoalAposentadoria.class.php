...
function recuperaAposentadoriaEsfinge(&$rsRecordSet, $stFiltro="", $stOrder="", $boTransacao="")
{
    return $this->executaRecupera( "montaRecuperaAposentadoriaEsfinge", $rsRecordSet, $stFiltro, $stOrder, $boTransacao );
}
