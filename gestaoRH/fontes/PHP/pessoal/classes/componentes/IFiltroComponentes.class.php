...
/**
    ...
    * @subpackage componentes
    ...
    $Id: IFiltroComponentes.class.php 59612 2014-09-02 12:00:51Z gelson $
...
function geraFormulario(&$obFormulario)
{
    ...
    if ($this->getProcessarCompetencia()) {
        ...
        $this->obCmbTipoFiltro->obEvento->setOnChange("ajaxJavaScript('".CAM_GRH_PES_PROCESSAMENTO."OCIFiltroComponentes.php?".Sessao::getId()."&stTipoFiltro='+this.value+'&boQuebrarDisabled='+document.frm.boQuebrarDisabled.value,'gerarSpan' ); ".$stOnChange);
    }
