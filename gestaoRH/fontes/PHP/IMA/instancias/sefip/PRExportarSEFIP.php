...
switch ($stAcao) {
    case "exportar":
        ...
        $obExportador->setRetorno($pgForm."?inAno=".$_POST['inAno']."&inCodRecolhimentoTxt=".$_POST['inCodRecolhimentoTxt']."&inCodMes=".$_POST['inCodMes']);
        ...
        if ($_POST["boSefipRetificadora"]) {
            $arModalidades[] = array("cod_modalidade"=>5,"sefip"=>"9");
            $arModalidades[] = array("cod_modalidade"=>3,"sefip"=>"7");
        ...
        Sessao::write("boCompetencia13",$_POST["boCompetencia13"]);
        ...
        while (!$rsModalidades->eof()) {
            ...
            if ($_POST["boSefipRetificadora"]) {
                $stCodContratoRetificadora = "";
                foreach (Sessao::read("arContratosRetificadora") as $arContratoRetificadora) {
                    $stCodContratoRetificadora .= $arContratoRetificadora["cod_contrato"].",";
                }
                $stCodContratoRetificadora = substr($stCodContratoRetificadora,0,strlen($stCodContratoRetificadora)-1);
                if ($rsModalidades->getCampo("cod_modalidade") == 5) {
                    $boAdicionarFiltroExtra = true;
                    $stFiltro = " AND modalidade_recolhimento.cod_modalidade IN (1,2)";
                    Sessao::write("stFiltroRegistroTrabalhadoresExtra", " AND contrato_servidor.cod_contrato NOT IN (".$stCodContratoRetificadora.")");
                }
                if ($rsModalidades->getCampo("cod_modalidade") == 3) {
                    $stFiltro = " AND modalidade_recolhimento.cod_modalidade = 1";
                    Sessao::write("stFiltroRegistroTrabalhadoresExtra", " AND contrato_servidor.cod_contrato IN (".$stCodContratoRetificadora.")");
                }
                if ($rsModalidades->getCampo("cod_modalidade") == 4) {
                    $stFiltro = " AND modalidade_recolhimento.cod_modalidade = 2";
                    Sessao::write("stFiltroRegistroTrabalhadoresExtra", " AND contrato_servidor.cod_contrato IN (".$stCodContratoRetificadora.")");
                }
            } else {
            ...
            $stFiltroEntidade  = " AND entidade.cod_entidade = ".Sessao::getCodEntidade();
            ...
            $arHeaderArquivo[0]['tipo_remessa']                                  = $_POST["inTipoRemessa"];
            ...
            $arHeaderArquivo[0]['recolhimento']                                  = $_POST["inCodRecolhimento"];
            $arHeaderArquivo[0]['ind_recolhimento']                              = $_POST["inCodIndicadorRecolhimento"];
            $arHeaderArquivo[0]['modalidade']                                    = $stModalidade;
            $arHeaderArquivo[0]['data_recolhimento_fgts']                        = str_replace("/","",$_POST["dtRecolhimentoFGTS"]);
            $arHeaderArquivo[0]['ind_recolhimento_previdencia']                  = $_POST["inCodIndicadorRecolhimentoPrevidencia"];
            $arHeaderArquivo[0]['data_recolhimento_previdencia']                 = str_replace("/","",$_POST["dtRecolhimentoPrevidencia"]);
            ...
            ##########TOMADOR DE SERVIÇO
            if ( in_array($_POST["inCodRecolhimento"],array(130,135,150,155,211,317,337,608)) ) {
                include_once(CAM_GRH_PES_MAPEAMENTO."TPessoalAdidoCedido.class.php");
                $obTPessoalAdidoCedido = new TPessoalAdidoCedido();
                ...
                while (!$rsAdidoCedido->eof()) {
                    ...
                    $arTomadorServico[$inIndex]['gps']                                           = $_POST["gps"];
            ...
            //$arHeaderEmpresa[0]['aliquota_rat']                                  = str_pad((int) $rsRat->getCampo("aliquota_rat"),2,"0");
            ...
            $arHeaderEmpresa[0]['centralizacao']                                 = $_POST["centralizacao"];
            $arHeaderEmpresa[0]['simples']                                       = 1;
            $arHeaderEmpresa[0]['fpas']                                          = $_POST["fpas"];
            $dtCompetenciaFPas = $_POST["inAno"] ."-".$inMes;
            $arHeaderEmpresa[0]['outras_entidades']                              = ($_POST["fpas"] == 582 and $dtCompetenciaFPas >= "1998-10" ) ? $stCodigoOutrasEntidades : "";
            $arHeaderEmpresa[0]['gps']                                           = $_POST["gps"];
            ...
            if( !$_POST["boCompetencia13"] AND
            !(in_array($_POST["inCodRecolhimento"],array(145,307,317,327,337,345)))){
                include_once(CAM_GRH_PES_MAPEAMENTO."TPessoalAssentamentoGerado.class.php");
                        ...
                        while (!$rsAssentamentoSEFIP->eof()) {
                            ...
                            if (!($rsAssentamentoSEFIP->getCampo("cod_tipo") == 3 and $rsEventoRescisaoCalculado->getNumLinhas() == -1)) {
                                ...
                                if ($inCodSefipSaida != "") {
                                    ...
                                    if ( ($rsCategoriaMovimentacao->getCampo("indicativo") == "S" OR $rsCategoriaMovimentacao->getCampo("indicativo") == "N" OR $rsCategoriaMovimentacao->getCampo("indicativo") == "C") AND $_POST["boCompetencia13"]) {
                                        $stIndicativoRecolhimentoFgts = "";
                                    }
                                    ...
                                    if ($boPeriodoInicial) {
                                        ...
                                        $arMovimentacaoTrabalhador[$inIndex]['tipo_inscricao_tomador']                        = ( in_array($_POST["inCodRecolhimento"],array(130,135,150,155,608)) ) ? 1 : "";
                                        $arMovimentacaoTrabalhador[$inIndex]['inscricao_tomador']                             = ( in_array($_POST["inCodRecolhimento"],array(130,135,150,155,608)) ) ? $arContratosAdidosCedidosTomador[$rsContratos->getCampo("cod_contrato")] : "";
            ...
            while (!$rsContratos->eof()) {
                ...
                if ($nuTotalLinha > 0) {
                    ...
                    ######inscricao_tomador
                    if (in_array($_POST["inCodRecolhimento"],array(130,135,150,155,211,317,337,608)) and $arContratosAdidosCedidosTomador[$rsContratos->getCampo("cod_contrato")] != "") {
                    ...
                    $arRegistroTrabalhador[$inIndex]['inscricao_tomador']                             = ( in_array($_POST["inCodRecolhimento"],array(130,135,150,155,211,317,337,608)) ) ? $arContratosAdidosCedidosTomador[$rsContratos->getCampo("cod_contrato")] : "";
...
function processarFiltro(&$obTMapeamento)
{
    switch ($_POST['stTipoFiltro']) {
        ...
        case "local":
            ...
            $stJoin  = "     JOIN pessoal.contrato_servidor_local                                      \n";
