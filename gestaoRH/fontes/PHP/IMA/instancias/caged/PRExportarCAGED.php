...
$inClasseCnae = substr(eregi_replace("[^0-9 ]","",$rsConfiguracaoCaged->getCampo("cod_estrutural")),0,5);
$inSubClasseCnae = substr(eregi_replace("[^0-9 ]","",$rsConfiguracaoCaged->getCampo("cod_estrutural")),5,2);
