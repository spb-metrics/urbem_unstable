...
/**
    ...
    * Casos de uso: uc-04.08.01
    ...
    $Id: FLExportarRemessaBancoBrasil.php 59612 2014-09-02 12:00:51Z gelson $
*/
...
$obBtnOk = new Ok();
$obBtnOk->obEvento->setOnClick("montaParametrosGET('submeter','inCodConfiguracao,stSituacao,stAcao,inCodComplementar,stDesdobramento,stTipoFiltro,inCodAtributo,inCodMes,inAno',true);");
