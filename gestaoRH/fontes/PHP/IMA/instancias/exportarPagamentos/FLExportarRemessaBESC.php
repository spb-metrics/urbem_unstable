...
$obBtnOk = new Ok();
$obBtnOk->obEvento->setOnClick("montaParametrosGET('submeter','inTipoMovimento,inCodConfiguracao,stSituacao,stAcao,inCodComplementar,stDesdobramento,stTipoFiltro,inCodAtributo,inCodMes,inAno',true);");
