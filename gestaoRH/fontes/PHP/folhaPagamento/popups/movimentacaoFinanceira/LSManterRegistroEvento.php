...
/**
    ...
    * @ignore
    ...
    $Name$
    $Author: souzadl $
    $Date: 2007-03-16 10:32:43 -0300 (Sex, 16 Mar 2007) $
...
$pgFilt = "FL".$stPrograma.".php?".Sessao::getId()."&nomForm=".$_REQUEST["nomForm"]."&campoNom=".$_REQUEST["campoNom"]."&campoNum=".$_REQUEST["campoNum"]."&boEventoSistema=".$_REQUEST['boEventoSistema'];
