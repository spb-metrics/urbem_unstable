...
function fecharFolhaComplementar($boTransacao="")
{
    ...
    if (!$obErro->ocorreu()) {
        ...
        if (!$obErro->ocorreu() and $this->roRFolhaPagamentoPeriodoMovimentacao->obRFolhaPagamentoFolhaSituacao->getSituacao() == 'Aberto') {
            ...
            //$this->roRFolhaPagamentoPeriodoMovimentacao->roRFolhaPagamentoPeriodoContratoServidor->addRFolhaPagamentoRegistroEvento();
            //$this->roRFolhaPagamentoPeriodoMovimentacao->roRFolhaPagamentoPeriodoContratoServidor->roRFolhaPagamentoRegistroEvento->listarRegistroEventoPeriodo($rsRegistroEventoPeriodo,$boTransacao);
            ...
            $obTFolhaPagamentoRegistroEventoComplementar->recuperaContratosComRegistroDeEventoReduzido($rsContratosComplementar,"","",$boTransacao);
            ...
            if (trim($stCodContratos) != "") {
                ...
                $obTFolhaPagamentoRegistroEvento->recuperaRegistrosDeEventos($rsRegistroEventoPeriodo,$stFiltro,'',$boTransacao);
            }
            ...
            if (!$obErro->ocorreu()) {
                ...
                $rsContratos = $this->adicionarContratoAutomaticosFolhaSalario($rsContratosComplementar,$rsContratos,$boTransacao);
            }
