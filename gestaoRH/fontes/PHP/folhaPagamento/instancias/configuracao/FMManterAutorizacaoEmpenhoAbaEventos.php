...
$obHdnOpcoesConfiguracaoEventos->setValue("selecionaTodosSelect(inCodEventoSelecionados);selecionaTodosSelect(".$obISelectMultiploRegSubCarEsp->obCmbRegime->getName()."Selecionados);selecionaTodosSelect(".$obISelectMultiploRegSubCarEsp->obCmbSubDivisao->getName()."Selecionados);");
