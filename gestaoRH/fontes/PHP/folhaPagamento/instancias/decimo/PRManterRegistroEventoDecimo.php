...
switch ($stAcao) {
    case "alterar":
        ...
        $obTFolhaPagamentoContratoServidorPeriodo->setDado("cod_periodo_movimentacao"   ,$_POST["inCodPeriodoMovimentacao"]);
        $obTFolhaPagamentoContratoServidorPeriodo->setDado("cod_contrato"               ,$_POST["inCodContrato"]);
        ...
        $stFiltro = " AND cod_contrato = ".$_POST["inCodContrato"];
        $stFiltro.= " AND cod_periodo_movimentacao = ".$_POST["inCodPeriodoMovimentacao"];
        ...
        if ($_POST['stOkRetorno'] == "lista") {
            sistemaLegado::alertaAviso($pgList,"Matrícula ".$_POST['inRegistro'],"incluir","aviso", Sessao::getId(), "../");
        } else {
