...
$rsDados = version_compare(phpversion() , '5.0') < 0 ? Sessao::read('rsImoveis') : clone(Sessao::read('rsImoveis'));
$rsDados2 = version_compare(phpversion(), '5.0') < 0 ? Sessao::read('rsImoveis') : clone(Sessao::read('rsImoveis'));
