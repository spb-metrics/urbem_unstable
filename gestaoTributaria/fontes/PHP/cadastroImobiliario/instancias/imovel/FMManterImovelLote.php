...
/**
    ...
    * $Id: FMManterImovelLote.php 59612 2014-09-02 12:00:51Z gelson $
...
if ($_REQUEST['stAcao'] == "alterar") {
    ...
    $obLblCreci->setValue  ( $_REQUEST['stCreciResponsavel'] ." - ". $_REQUEST['stNomeCreci'] );
}
...
$obLblNumeroLote->setValue  ( $obRCIMImovel->roRCIMLote->getNumeroLote()." - Lote ".$_REQUEST["stTipoLote"] );
...
if ( $_REQUEST['stAcao'] == "alterar" AND $obRCIMImovel->obRCIMLogradouroEntrega->getCodigoLogradouro() ) {
...
if ( $obRCIMImovel->obRCIMConfiguracao->getNumeroIM() == 'false' and $_REQUEST['stAcao'] == "incluir") {
    $obFormulario->addComponente( $obTxtNumeroInscricao     );
} elseif ($_REQUEST['stAcao'] != "incluir") {
...
if ( ( $_REQUEST['stAcao'] == "alterar" ) && ( $_REQUEST['stCreciResponsavel'] != "" ) ) {
