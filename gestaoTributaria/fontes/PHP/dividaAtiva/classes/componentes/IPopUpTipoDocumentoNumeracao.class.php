...
class IPopUpTipoDocumentoNumeracao extends Objeto
{
    ...
    public function IPopUpTipoDocumentoNumeracao()
    {
        ...
        $this->obInnerDocumento->obCampoCod->obEvento->setOnFocus("ajaxJavaScript('".CAM_GT_DAT_INSTANCIAS."emissao/OCManterEmissao.php?".Sessao::getId()."','verificaHabilitaDocumento' );");
   ...
   public function geraFormulario(&$obFormulario)
   {
       ...
       $this->obInnerDocumento->obCampoCod->obEvento->setOnFocus("ajaxJavaScript($pgOcul,'verificaHabilitaDocumento' );");
