...
class TDATDividaDocumento extends Persistente
{
    ...
    */
    ...
    public function criaTabelasDocumentos($boTransacao = "")
    {
        ...
        $stSql = $this->montaCriaTabelasDocumentos($boTransacao);
        $this->setDebug( $stSql );
        $obErro = $obConexao->executaSQL( $rsRecordSet, $stSql, $boTransacao );
    ...
    public function montaCriaTabelasDocumentos($boTransacao = "")
    {
        $stSql = "
    ...
    public function deletaTabelaDocumentos($boTransacao = "")
    {
        ...
        $stSql = $this->montaDeletaTabelaDocumentos($boTransacao);
        $this->setDebug( $stSql );
        $obErro = $obConexao->executaSQL( $rsRecordSet, $stSql, $boTransacao );
    ...
    public function montaDeletaTabelaDocumentos($boTransacao = "")
    {
        $stSql = "
                DROP TABLE tmp_ded;
                DROP TABLE tmp_dedm;
