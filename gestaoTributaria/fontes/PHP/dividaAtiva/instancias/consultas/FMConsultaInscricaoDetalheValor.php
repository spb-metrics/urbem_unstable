...
$inNumParcelamento = $_REQUEST["num_parcelamento"];
...
//    $obButtonAtualizarData->obEvento->setOnClick("visualizarDetalhesAtualizaReemitida( '$inCodLancamento', '$inNumeracao', '$inExercicio', '$inCodParcela','', '$dtDataBase', '$dtVencimentoPR', '$inOcorrencia', '$stIdCarregamento', '$stInfoParcela','$inNumParcelamento');");
//    $obButtonAtualizarData->obEvento->setOnDblClick("visualizarDetalhesAtualizaReemitida( '$inCodLancamento', '$inNumeracao', '$inExercicio', '$inCodParcela','', '$dtDataBase', '$dtVencimentoPR', '$inOcorrencia', '$stIdCarregamento', '$stInfoParcela','$inNumParcelamento');");
//} else {
