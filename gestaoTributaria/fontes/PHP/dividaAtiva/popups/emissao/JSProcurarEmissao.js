...
/**
  ...
  * Data de criação : 26/09/2006
    ...
    * $Id: JSProcurarEmissao.js 62838 2015-06-26 13:02:49Z diogo.zarpelon $
...
function InsereTipoDoc( stR1, stR2 , stR3 ){
    ...
    var stNomCampoCombo = <?=$request->get('stNomCampoCombo') ? $request->get('stNomCampoCombo') : $request->get("campoNom") ;?>;
    window.opener.parent.frames['telaPrincipal'].document.frm.stNomCampoCombo.value = stR3;
