...
/**
    ...
    * Casos de uso : uc-03.04.33
    ...
    $Id: FMManterCompraDireta.php 65196 2016-05-02 17:49:38Z michel $
*/
...
$stJsDataContabil  = " if (this.value != '') { ajaxJavaScript('".$pgOcul."?".Sessao::getId()."&inCodEntidade='+this.value+'','recuperaUltimaDataContabil'); } else { jQuery('#stDtCompraDireta').val(''); }";
