...
<?php
  /**
    ...
    * Casos de uso: uc-03.05.26
    ...
    $Id: PRManterJulgamentoProposta.php 59612 2014-09-02 12:00:51Z gelson $
        ...
        case "dispensaLicitacao":
            ...
            if ($rsMapa->getElementos > 0) {
                ...
                if ($inTotalEmpatados > 0) {
                     ...
                     $stMensagemErro .=  "com fornecedores empatados. É preciso <strong>reclassificar participantes e informar a justificativa</strong> para que apenas um vença.";
                }
            }
