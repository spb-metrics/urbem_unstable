 ...
 * @ignore
 ...
 $Id: OCManterAta.php 59612 2014-09-02 12:00:51Z gelson $
...
switch ($_REQUEST['stCtrl']) {
    ...
    case "validaEdital" :
        ...
        list($inNumEdital, $stExercicioEdital) = array(explode('/', $_REQUEST['stNumEdital']) );
        ...
        if (is_numeric($inNumEdital) && is_numeric($stExercicioEdital)) {
            ...
            $obTLicitacaoEdital->setDado('num_edital' , $inNumEdital::int      );
            ...
            if ($rsLicitacaoEdital->getNumLinhas() < 1) {
                $stJs .= "alertaAviso('Edital inválido ".$_REQUEST['stNumEdital']."', 'n_incluir', 'erro', '".Sessao::getId()."'); \n";
