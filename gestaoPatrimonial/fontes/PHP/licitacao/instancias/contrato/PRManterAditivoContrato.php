...
if ($stMensagem != "") {
    ...
    case "incluir":
        ...
        SistemaLegado::alertaAviso($pgList.'?'.Sessao::getId()."&stAcao=$stAcao","Contrato: ".$_REQUEST['inNumContrato']."/".$_REQUEST['stExercicioContrato'],"incluir", "aviso", Sessao::getId(),"");
        break;
    ...
    case "alterar":
        ...
        SistemaLegado::alertaAviso($pgList.'?'.Sessao::getId()."&stAcao=$stAcao","Contrato: ".$_REQUEST['inNumContrato']."/".$_REQUEST['stExercicioContrato'],"alterar", "aviso", Sessao::getId(),"");
        break;
    ...
    case "anular":
        ...
        $obTLicitacaoContratoAditivo->inclusao();
        SistemaLegado::alertaAviso($pgList.'?'.Sessao::getId()."&stAcao=$stAcao","Contrato: ".$_REQUEST['inNumContrato']."/".$_REQUEST['stExercicioContrato'],"anular", "aviso", Sessao::getId(),"");
        break;
    }
}
