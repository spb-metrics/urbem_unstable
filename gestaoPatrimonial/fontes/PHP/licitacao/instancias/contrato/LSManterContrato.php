...
if ($_REQUEST["stAcao"] == "rescindir") {
       $stFiltro .=  " NOT EXISTS (SELECT * "
                     ."\n          FROM licitacao.rescisao_contrato "
                     ."\n          WHERE licitacao.rescisao_contrato.exercicio_contrato = licitacao.contrato.exercicio"
                     ."\n          AND licitacao.rescisao_contrato.cod_entidade = licitacao.contrato.cod_entidade"
                     ."\n          AND licitacao.rescisao_contrato.num_contrato = licitacao.contrato.num_contrato"
                     ."\n         ) and ";
}
